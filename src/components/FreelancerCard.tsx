  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
      ...
      <div className="flex items-center mb-4">
        ...
        <span className="font-medium text-gray-900 dark:text-white ml-1">{freelancer.rating.toFixed(1)}</span>
        <span className="mx-2 text-gray-400 dark:text-white/60">•</span>
        <CheckCircle className="h-5 w-5 text-green-600 dark:text-green-400" />
        <span className="text-gray-700 dark:text-white ml-1">{freelancer.completedProjects} projects</span>
      </div>
      ...
      <div className="flex items-center justify-between">
        <div>
          <span className="text-2xl font-bold text-gray-900 dark:text-white">${freelancer.hourlyRate}</span>
