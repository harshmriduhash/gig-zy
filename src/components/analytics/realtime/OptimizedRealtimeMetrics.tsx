...
import { useOptimizedRealtimeConnection } from '../../../hooks/useOptimizedRealtimeConnection';
import { RealtimeStatus } from './RealtimeStatus';

export function OptimizedRealtimeMetrics() {
  const { isConnected, error, retryCount, aggregatedData } = useOptimizedRealtimeConnection({
    tables: [
      { name: 'users', priority: 3 },
      { name: 'projects', priority: 2 },
      { name: 'transactions', priority: 1 }
    ],
    poolConfig: {
      maxConnections: 5,
      minConnections: 2,
