...
const serviceOptions = [
  ...
  { label: 'Model Development', value: 'development' },
  { label: 'Model Optimization', value: 'optimization' },
  { label: 'Pipeline Development', value: 'pipeline' }
];
...
export function MLServiceFilters() {
