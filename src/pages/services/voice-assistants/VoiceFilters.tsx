...
const serviceOptions = [
  ...
  { label: 'Voice Assistants', value: 'assistants' },
  { label: 'Speech Recognition', value: 'recognition' },
  { label: 'Voice Synthesis', value: 'synthesis' },
  { label: 'Multilingual Voice', value: 'multilingual' }
];
...
const budgetOptions = [
  ...
  { label: 'Under $2000', value: 'under_2000' },
  { label: '$2000 - $2500', value: '2000_2500' },
  { label: 'Over $2500', value: 'over_2500' }
];
...
const deliveryOptions = [
  ...
  { label: 'Up to 60 days', value: '60_days' }
];
