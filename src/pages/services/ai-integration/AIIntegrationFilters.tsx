...
const serviceOptions = [
  ...
  { label: 'OpenAI Integration', value: 'openai' },
  { label: 'Google Cloud AI', value: 'google_cloud' },
  { label: 'Azure AI Services', value: 'azure' },
  { label: 'AWS AI Services', value: 'aws' }
];
...
const deliveryOptions = [
  ...
  { label: 'Up to 14 days', value: '14_days' },
  { label: 'Up to 21 days', value: '21_days' },
  { label: 'Up to 30 days', value: '30_days' }
];

export function AIIntegrationFilters() {
